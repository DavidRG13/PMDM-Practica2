...
public class ToBuy_ProductRenderer extends Renderer<ToBuy_Product>{
	
	private OnClickListener listener;

	public ToBuy_ProductRenderer(Activity context, View view, OnClickListener listener) {
		super(context, view);
	...
	@Override
	public View renderObject(ToBuy_Product product) {
	...
	private void renderProduct(ToBuy_Product product){
